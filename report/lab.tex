...
\setlength{\abovedisplayskip}{2.5pt}
\begin{flalign*}
    \qquad A &= 2.00 \pm 0.01 \approx 2\pi/\sqrt{g}& \\ % \\[-3pt] for paragraphs
    % \qqquad &\phantom{{}={}} \text{ayo continuation br}\\
...
\subsection{Experimental Setup}
The same setup from Section \ref{sec 4 Finding the Q Factor} was used to calculate the Q factors. Videos of the pendulum were not just recorded to include a few swings for Section \ref{Period and Length}, but rather up to hundreds of swings to capture the complete dampening effect of the pendulum.

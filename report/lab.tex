...
\begin{flalign*}
    \quad \theta_0 &= \text{initial release angle in rad} & \\ % \\[-3pt] for paragraphs
    % \quad &\phantom{{}={}} \text{ayo continuation br}\\
    \quad T &= \text{pendulum's period in s} & \\
    \quad \phi_0 &= \text{angular phase shift in rad} & \\
...
\setlength{\abovedisplayskip}{2.5pt}
\begin{flalign*}
    \theta_0 &= \text{release angle in rad}\\
    T_0 &= \text{smallest measured period}, (4.40\pm0.03)\,\text{s} \\
    B &= \text{constant for symmetry}, -0.001\pm0.005\\
    C &= \text{constant for deviation}, 0.091\pm0.007
\end{flalign*}
}
